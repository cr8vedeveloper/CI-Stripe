...
<?= $this->section('content') ?>
    <div class="card p-4">
        ...
        <div class="card-body">
            ...
            <?php endif ?>
            <form class="form-text" method="POST" action="<?= base_url() ?>/auth/forgot-password" accept-charset="UTF-8"
                ...
                <div class="form-group text-center">
                    <input class="form-control btn btn-sm btn-primary col-6 mt-3" type="submit" id="submit" value="Send Verify code">
                </div>
            </form>
